...
func InsertRawBlocks(q dbcl.Querier, objects ...*RawBlock) error {
	...
	cols := []string{
		"chain_id", "hash", "height", "value", "difficulty",
		"uncle_count", "tx_count", "timestamp",
	}
...
func InsertBlocks(q dbcl.Querier, objects ...*Block) error {
	const table = "blocks"
	cols := []string{
		"chain_id", "value", "difficulty", "block_time", "hashrate",
		"uncle_rate", "profitability", "avg_profitability", "pending",
		"count", "uncle_count", "tx_count", "period", "start_time", "end_time",
	}
...
func InsertPartialBlocks(q dbcl.Querier, objects ...*Block) error {
	const table = "blocks"
	insertCols := []string{
		"chain_id", "value", "difficulty", "block_time", "hashrate", "uncle_rate",
		"profitability", "avg_profitability", "pending", "count", "uncle_count",
		"tx_count", "period", "start_time", "end_time",
	}
	updateCols := []string{
		"value", "difficulty", "block_time", "hashrate", "uncle_rate",
		"profitability", "count", "uncle_count", "tx_count",
	}
...
func InsertGlobalShares(q dbcl.Querier, objects ...*Share) error {
	...
	cols := []string{
		"chain_id", "miners", "workers", "accepted_shares", "rejected_shares", "invalid_shares",
...
func InsertPartialGlobalShares(q dbcl.Querier, objects ...*Share) error {
	...
	updateCols := []string{
		"miners", "workers", "accepted_shares", "rejected_shares", "invalid_shares",
		"accepted_adjusted_shares", "rejected_adjusted_shares", "invalid_adjusted_shares",
...
func InsertMinerShares(q dbcl.Querier, objects ...*Share) error {
	...
	cols := []string{
		"chain_id", "miner_id", "workers", "accepted_shares", "rejected_shares", "invalid_shares",
		"accepted_adjusted_shares", "rejected_adjusted_shares", "invalid_adjusted_shares",
		"hashrate", "avg_hashrate", "pending", "count", "period", "start_time", "end_time",
	}
...
func InsertPartialMinerShares(q dbcl.Querier, objects ...*Share) error {
	...
	updateCols := []string{
		"workers", "accepted_shares", "rejected_shares", "invalid_shares",
		"accepted_adjusted_shares", "rejected_adjusted_shares", "invalid_adjusted_shares",
		"hashrate", "count",
	}
...
func InsertWorkerShares(q dbcl.Querier, objects ...*Share) error {
	...
	cols := []string{
		"chain_id", "worker_id", "accepted_shares", "rejected_shares", "invalid_shares",
		"accepted_adjusted_shares", "rejected_adjusted_shares", "invalid_adjusted_shares",
		"hashrate", "avg_hashrate", "pending", "count", "period", "start_time", "end_time",
	}
...
func InsertPartialWorkerShares(q dbcl.Querier, objects ...*Share) error {
	...
	updateCols := []string{
		"accepted_shares", "rejected_shares", "invalid_shares",
		"accepted_adjusted_shares", "rejected_adjusted_shares", "invalid_adjusted_shares",
		"hashrate", "count",
	}
...
func InsertGlobalEarnings(q dbcl.Querier, objects ...*Earning) error {
	...
	cols := []string{
		"chain_id", "value", "avg_value", "pending",
		"count", "period", "start_time", "end_time",
	}
...
func InsertMinerEarnings(q dbcl.Querier, objects ...*Earning) error {
	...
	cols := []string{
		"chain_id", "miner_id", "value", "avg_value",
