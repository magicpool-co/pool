...
INSERT INTO nodes (url, chain_id, region, mainnet, enabled, backup, active, synced, height) VALUES 
	...
	("node-1.erg.us-west-2.privatemagicpool.co", "ERG", "us-west-2", true, true, false, false, false, 0),
	("node-0.erg.eu-central-1.privatemagicpool.co", "ERG", "eu-central-1", true, true, false, false, false, 0),
	("node-1.erg.eu-central-1.privatemagicpool.co", "ERG", "eu-central-1", true, true, false, false, false, 0),
	("node-0.erg.ap-southeast-1.privatemagicpool.co", "ERG", "ap-southeast-1", true, true, false, false, false, 0),
	("node-1.erg.ap-southeast-1.privatemagicpool.co", "ERG", "ap-southeast-1", true, true, false, false, false, 0),
