...
INSERT INTO nodes (url, chain_id, region, mainnet, enabled, backup, active, synced, height) VALUES 
	...
	("node-1.kas.us-west-2.privatemagicpool.co", "KAS", "us-west-2", true, true, false, false, false, 0),
	("node-0.kas.eu-central-1.privatemagicpool.co", "KAS", "eu-central-1", true, true, false, false, false, 0),
	("node-1.kas.eu-central-1.privatemagicpool.co", "KAS", "eu-central-1", true, true, false, false, false, 0),
	("node-0.kas.ap-southeast-1.privatemagicpool.co", "KAS", "ap-southeast-1", true, true, false, false, false, 0),
	("node-1.kas.ap-southeast-1.privatemagicpool.co", "KAS", "ap-southeast-1", true, true, false, false, false, 0);
