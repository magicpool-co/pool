...
const (
	...
	nexaCharset          = "qpzry9x8gf2tvdw0s3jn54khce6mua7l"
	nexaPubKeyAddrID     = 0x00
	nexaScriptHashAddrID = 0x08
	nexaTemplateAddrID   = 0x98
)
...
func TestEncodeDecodeBCH(t *testing.T) {
	tests := []struct {
		...
		// NEXA
		{
			charset: nexaCharset,
			prefix:  "nexa",
			version: nexaPubKeyAddrID,
			body: []byte{
				0x76, 0xa0, 0x40, 0x53, 0xbd, 0xa0, 0xa8, 0x8b,
				0xda, 0x51, 0x77, 0xb8, 0x6a, 0x15, 0xc3, 0xb2,
				0x9f, 0x55, 0x98, 0x73,
			},
			encoded: "nexa:qpm2qsznhks23z7629mms6s4cwef74vcwvgpsey0xy",
		},
		{
			charset: nexaCharset,
			prefix:  "nexatest",
			...
			encoded: "nexatest:qpm2qsznhks23z7629mms6s4cwef74vcwvx26kzw52",
		},
		{
			charset: nexaCharset,
			prefix:  "nexa",
			version: nexaPubKeyAddrID,
			body: []byte{
				0xcb, 0x48, 0x12, 0x32, 0x29, 0x9c, 0xd5, 0x74,
				0x31, 0x51, 0xac, 0x4b, 0x2d, 0x63, 0xae, 0x19,
				0x8e, 0x7b, 0xb0, 0xa9,
			},
			encoded: "nexa:qr95sy3j9xwd2ap32xkykttr4cvcu7as4yrtkg2qqa",
		},
		{
			charset: nexaCharset,
			prefix:  "nexatest",
			...
			encoded: "nexatest:qr95sy3j9xwd2ap32xkykttr4cvcu7as4ydqu8vpjn",
		},
		{
			charset: nexaCharset,
			prefix:  "nexa",
			version: nexaPubKeyAddrID,
			body: []byte{
				0x01, 0x1f, 0x28, 0xe4, 0x73, 0xc9, 0x5f, 0x40,
				0x13, 0xd7, 0xd5, 0x3e, 0xc5, 0xfb, 0xc3, 0xb4,
				0x2d, 0xf8, 0xed, 0x10,
			},
			encoded: "nexa:qqq3728yw0y47sqn6l2na30mcw6zm78dzq0jl7vjk6",
		},
		{
			charset: nexaCharset,
			prefix:  "nexatest",
			...
			encoded: "nexatest:qqq3728yw0y47sqn6l2na30mcw6zm78dzqpe432ny5",
		},
	}
