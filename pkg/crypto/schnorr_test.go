...
func TestSchnorrSignBCH(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			sig: []byte{
				0xe7, 0x16, 0x7a, 0xe0, 0xaf, 0xbb, 0xa6, 0x01,
				0x9b, 0x4c, 0x7f, 0xcf, 0xe6, 0xde, 0x79, 0x16,
				0x5d, 0x55, 0x5e, 0x82, 0x95, 0xbd, 0x72, 0xda,
				0x1b, 0x8a, 0xa1, 0xa5, 0xb5, 0x43, 0x05, 0x88,
				0x05, 0x17, 0xca, 0xce, 0x1b, 0xcb, 0x0c, 0xb5,
				0x15, 0xe2, 0xee, 0xaf, 0xfd, 0x49, 0xf1, 0xe4,
				0xdd, 0x49, 0xfd, 0x72, 0x82, 0x6b, 0x4b, 0x15,
				0x73, 0xc8, 0x4d, 0xa4, 0x9a, 0x38, 0x40, 0x5d,
			},
		},
	}
