...
func TestGenerateTx(t *testing.T) {
	tests := []struct {
		...
		// @TODO: this uses a hybrid address that was serialized differently in the older version of btcec,
		// its probably best to just regenerate and broadcast a similar tx on testnet
		/*{
			priv:       "613cd5bb4e5083635609558f89fff1b662edd12f0732ab140b7ee9f688730800",
			baseTx:     baseTxBTC,
			feePerByte: 2,
			inputs: []*types.TxInput{
				&types.TxInput{
					Hash:  "806c612c22de1d8fe1cbdf2a29427385817be95cba8e440cdfd5b9c1bc4f10b6",
					Index: 0,
					Value: new(big.Int).SetUint64(14101),
				},
			},
			outputs: []*types.TxOutput{
				// compressed
				&types.TxOutput{
					Address:  "0319c980631d9039e3abe7768ec96e91c97cb85073c579d3c8eebe12ec86f42fbf",
					Value:    new(big.Int).SetUint64(5101),
					SplitFee: true,
				},
				// uncompressed
				&types.TxOutput{
					Address:  "0419c980631d9039e3abe7768ec96e91c97cb85073c579d3c8eebe12ec86f42fbf08be7bd54fa7ebe9dad426b6777bdb6ccaa00a69ff040ca526f67ccdd2bf40d3",
					Value:    new(big.Int).SetUint64(3000),
					SplitFee: true,
				},
				// hybrid
				&types.TxOutput{
					Address:  "0719c980631d9039e3abe7768ec96e91c97cb85073c579d3c8eebe12ec86f42fbf08be7bd54fa7ebe9dad426b6777bdb6ccaa00a69ff040ca526f67ccdd2bf40d3",
					Value:    new(big.Int).SetUint64(3000),
					SplitFee: true,
				},
				// P2WSH
			...
			tx: []byte{
				,
			},
		},*/
		// RVN tests
		{
